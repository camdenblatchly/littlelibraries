...
fig <- most_popular_book_categories %>%
  ...
  labs(
    ...
    subtitle = "At Somerville-area little libraries",
    x = NULL,
    y = NULL,
...
fig <- dta_raw %>%
  ...
  labs(
    ...
    subtitle = "For Somerville-area little libraries",
    x = NULL,
    y = NULL,
    caption = "Source: Open Library & Google Books APIs"
  ) +
...
fig <- ggplot(dta_raw, aes(x = length)) +
  geom_histogram(binwidth = 50, fill = chart_color, color = "white") +
  scale_y_continuous(
    labels = NULL,
    expand = expansion(mult = c(0, .1))
  ) +
  ...
  #   binwidth = 50,
  #   aes(
  #     label = after_stat(scales::label_comma(accuracy = 1)(count)),
  #     y = after_stat(count)
  #   ),
  #   fontface = "bold",
  #   family = "Lato",
  ...
  labs(
    title = "Page length distribution",
    subtitle = "For Somerville-area little libraries",
    x = NULL,
    y = NULL,
    caption = "Source: Open Library & Google Books APIs"
